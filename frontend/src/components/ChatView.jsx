...
export default function ChatView({ 
  ...
  const pipelineStages = [
    ...
    { id: 'Vector Search', name: 'Vector Database Search', desc: 'Executes Cosine Similarity match against index. Retrieves top 20 candidate chunks.', key: 'vector' },
    { id: 'Reranker', name: 'Cross-Encoder Reranker', desc: 'Applies deep Reranking model to score semantic relevance of text pairs, filtering top 5.', key: 'rerank' },
